...
namespace MultiShop.Web.UI.Areas.Admin.Controllers
{
    ...
    public class ProductController : Controller
    {
        ...
        public async Task<IActionResult> CreateProduct(CreateProductDto createProductDto)
        {
            ...
            var responsemessage = await client.PostAsync("https://localhost:7070/api/Product", stringContent);
            if (responsemessage.IsSuccessStatusCode)
            {
        ...
        {
            var client = _httpClientFactory.CreateClient();
            var responsoMessage = await client.DeleteAsync("https://localhost:7070/api/Product/id?id=" + id);
